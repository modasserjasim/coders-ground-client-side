    ...
    return (
        <div className=" bg-gray-900 px-4">
            <div className="max-w-5xl mx-auto text-white py-10">
                ...
                <div className="mt-16 md:mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                    <p className="order-2 md:order-1 mt-8 md:mt-0 text-center">
                        ...
                        <span className="px-2 border-l hover:text-primary"><Link>Privacy Policy</Link></span>
                        <span className="px-2 border-l hover:text-primary"><Link>Terms and Conditions</Link></span>
