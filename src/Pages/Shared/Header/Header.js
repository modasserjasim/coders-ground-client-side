                ...
                <div>
                    <div className="flex items-center gap-7 justify-between py-2 md:block">
                        <Link className='flex items-center' to='/'>
                            ...
                            <DiCodeBadge className='text-5xl md:text-7xl text-primary' />
                            <div>
                                <h2 className='text-xl md:text-3xl font-extrabold leading-none'>CODERS</h2>
                                <h2 className='text-xl md:text-3xl md:-mt-2 font-extrabold leading-none'>GROUND</h2>
                            </div>
                        </Link>
                        ...
                        <div className="flex items-center md:hidden">
                            <label className="swap swap-rotate mr-2">
                                <input type="checkbox" />
                                <IoSunnyOutline data-set-theme="dark" data-act-class="ACTIVECLASS" className="swap-on fill-current text-3xl" />
                                <IoMoonOutline data-set-theme="winter" data-act-class="ACTIVECLASS" className="swap-off fill-current text-3xl" />
                            </label>
                    ...
                    >
                        <div className='flex items-center space-x-6'>
                            <ul className="items-center justify-center space-y-4 md:flex md:space-x-8 md:space-y-0 font-semibold uppercase">
                                ...
                                <li className=" hover:text-primary">
                                    <NavLink to='/courses' className={({ isActive }) => isActive ? 'text-primary' : ''}>Courses</NavLink>
                                </li>
                                <li className=" hover:text-primary">
                                    <NavLink to='/faq' className={({ isActive }) => isActive ? 'text-primary' : ''}>FAQ</NavLink>
                                </li>
                                <li className=" hover:text-primary">
